...
export default function WarrantyContent() {
  return (
    <div className="max-w-4xl mx-auto rounded-lg">
      <h1 className="text-3xl mb-6 text-center font-tthoves-bold">
        Yudu Robotics Products Warranty - Terms and Conditions
      </h1>
      <section>
        <h2 className="text-2xl mb-4 font-tthoves-semiBold">1. Warranty</h2>
        <h3 className="text-xl mb-2 font-tthoves-medium">1.1 Duration of Warranty</h3>
        ...
        <h3 className="text-xl mb-2 font-tthoves-medium">1.2 Warranty Coverage (Inclusions)</h3>
        ...
        <h3 className="text-xl mb-2 font-tthoves-medium">1.3 Exclusions from Warranty</h3>
        <ul className="list-disc list-inside mb-4 font-tthoves">
        ...
        <h3 className="text-xl mb-2 font-tthoves-medium">1.4 Items Exempted from Warranty</h3>
        ...
        <h3 className="text-xl mb-2 font-tthoves-medium">1.5 Proof of Purchase Requirement</h3>
        <p className="mb-4 font-tthoves">
          Warranty claims must include proof of purchase, such as the original invoice.
        </p>
        <h3 className="text-xl mb-2 font-tthoves-medium">1.6 Replacement and Repairs</h3>
        <p className="mb-4 font-tthoves">
        ...
        <h3 className="text-xl mb-2 font-tthoves-medium">1.9 Warranty Limitations</h3>
        <p className="mb-4 font-tthoves">Warranty applies only to the original purchaser and is non-transferable.</p>
        <h3 className="text-xl mb-2 font-tthoves-medium">1.10 Exclusion of Indirect Damages</h3>
        <p className="mb-4 font-tthoves">
          The company is not liable for incidental, indirect, or consequential damages, including data or profit loss.
        </p>
        <h3 className="text-xl mb-2 font-tthoves-medium">1.11 Updates to Warranty Terms</h3>
        <p className="mb-4 font-tthoves">
          Warranty terms may change without prior notice. Updated terms apply from the date of publication.
        </p>
      </section>
      <section>
        <h2 className="text-2xl mb-4 font-tthoves-semiBold">2. Extended Warranty</h2>
        <p className="mb-4 font-tthoves">
          Extended warranty options are available for an additional fee. Contact support for more details.
        </p>
      </section>
      <section>
        <h2 className="text-2xl mb-4 font-tthoves-semiBold">3. Contact Information</h2>
        <p className="mb-4 font-tthoves">
