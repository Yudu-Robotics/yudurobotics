...
export default function ProductCatalog() {
  return (
    <div className="flex flex-col space-y-4">
      <h2 className="text-primary font-semibold text-xl lg:text-base text-center lg:text-start ">Product Catalog</h2>
      ...
      <div className="flex flex-col space-y-6 lg:space-y-0 lg:flex-row justify-between">
        <p className="text-gray-600 text-base text-center lg:text-start lg:text-lg w-[100%] lg:w-[50%]">
          Discover the exciting products we’ve been developing—each designed to
          push the boundaries of robotics.
        </p>
        <Button className="py-6 px-8 text-xs lg:text-sm rounded-3xl ">Veiw all products {"->"}</Button>
      </div>
    </div>
  );
}
