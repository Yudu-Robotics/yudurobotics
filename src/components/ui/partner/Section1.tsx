        ...
        <div className="text-center xl:mt-6 w-3/4">
          ...
          <div className="relative">
            <span>
              ...
              and fancy sentences. But honestly, we're here to have a real
          ...
          <br />
          <br />
          So here’s what we’re <span className="font-bold italic">
            NOT
          </span>{" "}
          about
        </div>
          ...
          <div className="w-full flex flex-col justify-between lg:-translate-y-16">
            {data.map((item: any) => (
              ...
              >
                ...
                <div
                  className="font-tthoves text-[60px] sm:text-[60px] w-full  font-display  font-bold  text-left underline-offset-from-font decoration-skip-ink-none"
                  style={{
                    fontWeight: 900,
                    lineHeight: "1",
                ...
                >
                  <span className="block">
                    {item.title1.split(" ")[0]}{" "}
                    <span className="italic">{item.title1.split(" ")[1]}</span>{" "}
                    {item.title1.split(" ").slice(2).join(" ")}
                  </span>
                  <span
                    className={`font-tthoves text-[60px] sm:text-[60px] w-full  ${item.bg} block`}
                    style={{
                      fontWeight: 900,
                      lineHeight: "1",
                      fontFamily: "'YourFontFamily', sans-serif",
                ...
                <div
                  className="w-[80%] mt-4 text-lg flex items-center h-auto text-left font-light leading-[var(--Lineheighttext-lg)] decoration-skip-ink-none"
                  style={{
                    fontFamily: "var(--Fontfamilyfont-family-body)",
                    fontSize: "var(--Fontsizetext-lg)",
                  }}
                >
                  {item.desc}
                </div>
          ...
          <div className="w-full flex flex-col justify-between lg:-translate-y-16">
            {data.map((item: any) => (
              ...
              >
                {/* Left section - 70% width on desktop, full width on mobile */}
                <div
                  className="font-cobaltRidge sm:text-[60x] md:text-[48px] lg:text-[60px] sm:w-[60%] md:w-[70%]"
                  style={{ lineHeight: "1" }}
                >
                  <span className="block">{item.title1}</span>
                  <span
                    className={`font-cobaltRidge sm:text-[36px] md:text-[48px] lg:text-[60px] sm:w-[70%] md:w-[70%] ${item.bg} block`}
                  >
                    {item.title2}
                  </span>
                </div>
