  ...
  return (
    <>
      <div className="sm:translate-y-9 ">
        ...
        <div className="flex justify-end sm:-translate-x-[-10] md:-translate-x-8 md:-translate-y-12 md:-mt-20 lg:-translate-x-8 lg:-translate-y-12 lg:-mt-24 xl:-translate-x-8 xl:-translate-y-32 xl:-mt-12 2xl:-translate-x-4 2xl:-mt-8 relative z-10">
