...
export default function Curious({ jumppingButton }: CuriousProps) {
  ...
  return (
    ...
    <div className="bg-primary  rounded-xlg sm:rounded-xxl p-6 sm:p-10 mt-16  lg:mt-40 relative shadow-xl overflow-hidden">
      ...
      <div className="flex flex-col space-y-16 lg:flex-row lg:space-y-0 justify-between items-center lg:items-start py-4 px-4 sm:px-8 lg:py-8 md:px-12 lg:px-16 xl:px-20">
        ...
        <div className="w-full">
          <div className="space-y-4">
            {/* Main Heading */}
            <div className="font-piepie text-4xl md:text-3xl lg:text-4xl xl:text-6xl text-primary-foreground leading-tight">
              Curious about the
              <br />
