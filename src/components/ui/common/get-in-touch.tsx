  ...
  return (
    <div className="flex flex-col space-y-6 justify-center items-center">
      ...
      <div className="flex flex-col space-y-1 items-center text-center">
        <h1 className="text-base font-bold sm:text-sm md:text-md lg:text-lg xl:text-xl ">
          Still have questions?
        </h1>
        <p className="text-secondary-foreground sm:text-sm md:text-md lg:text-lg xl:text-xl ">
