...
export default function Roboki() {
  ...
  return (
    <>
      <div>
        <div className="flex flex-col px-8 lg:px-28 sm:py-4 bg-primary -mb-40">
          <div className="flex flex-col space-y-16 lg:flex-row lg:space-y-0 justify-between py-10">
            <div className="w-full">
              ...
              <div className="space-y-4 w-full ">
                ...
                {/* Subtext */}
                <div className="text-opacity-35 text-primary-foreground sm:text-sm md:text-md lg:text-lg xl:text-xl font-body w-[100%] sm:w-[60%] text-lg sm:text-start text-center">
                  {data.subheading}
                </div>
              </div>
            </div>
